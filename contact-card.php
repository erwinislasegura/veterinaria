			...
			<div class="container-fluid">
										...
										<form id="addContactModalTitle">
											<div class="image-placeholder">
												...
												<div class="avatar-preview">
													<div id="imagePreview" style="background-image: url('assets/images/contacts/user.jpg');">
													</div>
												</div>
											</div>
				...
				<div class="tab-content">
					<div class="tab-pane fade show active" id="navpills-1" >
									...
									<div class="card-body user-profile">
										...
										<div class="media-body user-meta-info">
											...
											<ul>
												...
												<li><a href="page-chat.php"><i class="las la-sms"></i></a></li>
						...
						<div class="row mb-5">
							<div class="col-xl-12 d-flex justify-content-center">
								<a href="javascript:void(0);" class="btn btn-outline-primary dz-load-more" id="allContactList"  rel="ajax/contact-list.php">Load More</a>
							</div>
						</div>
					</div>
					<div class="tab-pane fade" id="navpills-2">
						...
						<div class="row mb-5">
							<div class="col-xl-12 d-flex justify-content-center">
								<a href="javascript:void(0);" class="btn btn-outline-primary dz-load-more" id="pendingList"  rel="ajax/contact-list.php">Load More</a>
							</div>
						</div>
					</div>
				</div>
