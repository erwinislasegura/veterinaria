										...
										<div class="tab-content dz-scroll" id="message-bx">
											<div class="tab-pane fade show active" id="AllMessage" role="tabpanel">
												<div class="chat-list-area" data-chat="person1">
													<div class="image-bx">
														<img src="assets/images/users/pic1.jpg" alt="" class="rounded-circle img-1">
												...
												<div class="chat-list-area active" data-chat="person2">
													<div class="image-bx">
														<img src="assets/images/users/pic2.jpg" alt="" class="rounded-circle img-1">
														<span class="active"></span>
													</div>
													<div class="info-body">
														<div class="d-flex">
												...
												<div class="chat-list-area" data-chat="person3">
													<div class="image-bx">
														<img src="assets/images/users/pic3.jpg" alt="" class="rounded-circle img-1">
														<span class="active"></span>
													</div>
													<div class="info-body">
														<div class="d-flex">
												...
												<div class="chat-list-area" data-chat="person4">
													<div class="image-bx">
														<img src="assets/images/users/pic4.jpg" alt="" class="rounded-circle img-1">
													</div>
													<div class="info-body">
														<div class="d-flex">
												...
												<div class="chat-list-area" data-chat="person5">
													<div class="image-bx">
														<img src="assets/images/users/pic5.jpg" alt="" class="rounded-circle img-1">
													</div>
													<div class="info-body">
														<div class="d-flex">
												...
												<div class="chat-list-area" data-chat="person6">
													<div class="image-bx">
														<img src="assets/images/users/pic6.jpg" alt="" class="rounded-circle img-1">
													</div>
													<div class="info-body">
														<div class="d-flex">
												...
												<div class="chat-list-area" data-chat="person7">
													<div class="image-bx">
														<img src="assets/images/users/pic7.jpg" alt="" class="rounded-circle img-1">
													</div>
													<div class="info-body">
														<div class="d-flex">
												...
												<div class="chat-list-area" data-chat="person8">
													<div class="image-bx">
														<img src="assets/images/users/pic8.jpg" alt="" class="rounded-circle img-1">
													</div>
													<div class="info-body">
														<div class="d-flex">
												...
												<div class="chat-list-area" data-chat="person9">
													<div class="image-bx">
														<img src="assets/images/profile/Untitled-2.jpg" alt="" class="rounded-circle img-1">
													</div>
													<div class="info-body">
														<div class="d-flex">
									...
									<div class="message-bx chat-box">
										<div class="d-flex justify-content-between chat-box-header">
											<div class="d-flex align-items-center">
												<img src="assets/images/users/pic2.jpg" alt="" class="rounded-circle main-img me-3">
										...
										<div class="chat-box-area dz-scroll" id="chartBox" style="background-image:url('assets/images/chat-bg.png');">
