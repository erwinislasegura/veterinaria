							...
							<table class="table display mb-4 dataTablesCard short-one card-table text-black" id="example6">
								...
								<tbody>
									<tr>
										...
										<td>
											<div class="d-flex align-items-center">
												<img src="assets/images/table/Untitled-1.jpg"  class="rounded-circle me-2 width36 height36" alt="">
												<span>Samuel</span>
											</div>
										</td>
										<td class="wspace-no">
									...
									<tr>
										...
										<td>
											<div class="d-flex align-items-center">
												<img src="assets/images/table/Untitled-2.jpg"  class="rounded-circle me-2 width36 height36" alt="">
												<span>Cindy</span>
											</div>
										</td>
										<td class="wspace-no">
									...
									<tr>
										...
										<td>
											<div class="d-flex align-items-center">
												<img src="assets/images/table/Untitled-3.jpg"  class="rounded-circle me-2 width36 height36" alt="">
												<span>Marquezz</span>
											</div>
										</td>
										<td class="wspace-no">
									...
									<tr>
										...
										<td>
											<div class="d-flex align-items-center">
												<img src="assets/images/table/Untitled-4.jpg"  class="rounded-circle me-2 width36 height36" alt="">
												<span>David</span>
											</div>
										</td>
										<td class="wspace-no">
